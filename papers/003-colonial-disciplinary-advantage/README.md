...
- [x] preregistration draft plus dated implementation/estimator/temporal amendments;
...
- [x] CEPII Gravity V202211 audited and committed: complete 12,561-pair
      159-country universe, 156 historical colonial/dependency ties, checksum manifest;

Still integrity-gated:

- [ ] independent blinded Coder B in a genuinely fresh GPTPage/model context;
- [ ] outcome-blind A/B adjudication and `IKES_FROZEN.csv` with full
      cryptographic provenance of raw/notes/A/B/adjudication/frozen artifacts.
...
- `code/run_confirmatory_models.py` implements the three headline 2019–2022
  tests, pooled and period-specific persistence profiles, 2023–2025 output-only
  sensitivity, 999 IKES-label permutations, leave-one-discipline-out, volume,
  and median-IKES sensitivities;
...
All historical/source gates are already closed: COLDAT, CEPII and the OpenAlex
schema probe are committed and audited.
