# ARIS4C003 Coder B — Output Template

This file is a formatting aid only. Do not place real scores here in the
repository before the independent pass.

## Part 1

Use one fenced CSV block:
...
Use exactly 21 headings in D01–D21 order:

`### D01 — Anthropology`

Rationale, sources, uncertainty, and NA dimensions.
