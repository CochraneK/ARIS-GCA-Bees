...
- Treat admissible response semantics as part of query complexity.
- Compare binary and richer semantic protocols rather than assuming MAYBE-like states always help.
