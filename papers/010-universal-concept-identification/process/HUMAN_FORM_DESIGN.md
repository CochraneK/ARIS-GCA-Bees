...
The first human calibration compares **P2 versus P6** on the same underlying target-query universe.
...
- 36 base forms;
- each duplicated as P2 and P6;
- 72 participant forms total.
...
Therefore a complete 72-participant cycle, with one participant per form, gives balanced first-pass coverage under both P2 and P6.
...
A participant uses one response protocol throughout a form.
...
- comparison of P2 versus P6 retest reliability.
