...
- **Next gate:** Qualify archived Table-1 image object as SAFE_EXACT, then run F3 content extraction
- **Blocker:** Historical table image replay/qualification remains the object-level gate
