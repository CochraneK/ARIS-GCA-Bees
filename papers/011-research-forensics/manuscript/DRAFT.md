...
### 7.5 Seed acquisition attrition

We then converted the six-case source-anatomy seed into an issue-specific acquisition funnel. Three documented correction/error cases were classified as content-eligible for primary Track A issue recall and required, respectively, a historical figure image, a second historical figure image, and a historical table. Two official retraction issues—gift authorship and manipulated peer review—were classified as content-ineligible for primary manuscript-content issue recall. One retraction notice gave broad concerns about scientific accuracy and legitimacy but lacked a sufficiently specific issue type for confirmatory issue-level scoring and was therefore held for adjudication.

Two of the six target papers had at least one verified SAFE_EXACT historical object: pre-correction publisher HTML for the PLOS case and pre-retraction publisher HTML/PDF for the J-STAGE case. However, none of the three clearly content-eligible issues was yet SAFE_EXACT-ready at the artifact role required to evaluate that issue. The PLOS historical HTML did not establish time safety for the historical figure image; no pre-correction Figure 6 object had been recovered for the Nature case in the initial archive pass; and the pre-erratum SAGE table object remained unverified. Thus the seed produced 0/3 issue-ready content-eligible cases despite 2/6 papers having at least one exact historical object.
