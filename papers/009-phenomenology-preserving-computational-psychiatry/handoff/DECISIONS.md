...
- Separate acquisition fidelity from encoding/model fidelity.
- Do not treat a computational representation as equivalent to phenomenology merely because prediction is good.
