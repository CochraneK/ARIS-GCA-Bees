...
All data analysed in this study are third-party public linguistic resources (TLI/GBI, WALS, and Glottolog). For double-anonymised peer review, analysis code, machine-readable stage outputs, and figure-generation scripts are provided as anonymised supplementary files with the submission. A permanent public repository reference and immutable input manifest will be supplied in the final accepted version.
