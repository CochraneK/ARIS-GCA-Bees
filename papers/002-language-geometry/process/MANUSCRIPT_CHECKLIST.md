# Paper 002 · Manuscript Checklist

## Secondary-review mandatory items

- [x] State bootstrap = split-sensitivity uncertainty, not phylogenetic uncertainty.
- [x] State residual genealogical/contact dependence is not fully removed.
- [x] Label Stage 1–1I exploratory/screening.
...
- [x] Audit core bibliography metadata against publisher/authoritative records; reformat/re-resolve at target-journal stage.
