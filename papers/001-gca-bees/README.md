...
ARIS4C001 is finalized as a quantitative synthesis + theory/model-comparison article.

Main published-summary results:
- AL–RL pooled descriptive r ≈ **0.560**
- AL–NP ≈ **0.436**
- RL–NP ≈ **0.225**
- Tucker congruence of published visual vs olfactory loading vectors = **0.99996**
- published one-factor variance: **46.8% visual**, **52.3% olfactory**
