"""Architecture-balanced recoverability diagnostic for ARIS4C008.
...
def main():
    ...
    with open(base/"data"/"tier1_recoverability_v2.csv","w",newline="",encoding="utf-8") as f:
    ...
    with open(base/"data"/"tier1_recoverability_confusion_v2.csv","w",newline="",encoding="utf-8") as f:
