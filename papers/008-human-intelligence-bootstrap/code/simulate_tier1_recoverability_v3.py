...
def scenarios(base):
    ...
    sc={
      ...
      "pilot9_plus_D_complete":fill_cols(m79_pilot9,[3]),
      "pilot9_plus_E_complete":fill_cols(m79_pilot9,[4]),
      "pilot9_plus_F_complete":fill_cols(m79_pilot9,[5]),
      "pilot9_plus_ABE_complete":fill_cols(m79_pilot9,[0,1,4]),
      "pilot9_plus_CDF_complete":fill_cols(m79_pilot9,[2,3,5]),
