...
|---|---|---:|---:|---|---:|
| **001** | [Bee GCA × Uncertainty](papers/001-gca-bees/) | 🔵 Finish | 100% | [handoff](papers/001-gca-bees/handoff/AGENT_HANDOFF.md) | <a href="./docs/assets/paper-at-a-glance/001.webp"><img src="./docs/assets/paper-at-a-glance/001-thumb.svg" height="56" alt="One-page visual 001" title="Click to open the full one-page visual"></a> |
| **002** | [Testing linguistic periodicity](papers/002-language-geometry/) | 🔵 Finish | 100% | [handoff](papers/002-language-geometry/handoff/AGENT_HANDOFF.md) | <a href="./docs/assets/paper-at-a-glance/002.webp"><img src="./docs/assets/paper-at-a-glance/002-thumb.svg" height="56" alt="One-page visual 002" title="Click to open the full one-page visual"></a> |
